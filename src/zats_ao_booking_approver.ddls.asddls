...
define view entity ZATS_ao_BOOKING_APPROVER as projection on ZATS_AO_BOOKING
{
    key TravelId,
    key BookingId,
    BookingDate,
    ...
    /* Associations */
    _BookingStatus,
    _BookingSupplement: redirected to composition child ZATS_AO_BOOKSUPPL_APPROVER,
    _Carrier,
    _Connection,
    _Customer,
    _Travel: redirected to parent ZATS_AO_TRAVEL_APPROVER
}
