CLASS zcl_ats_ao_calc DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_ats_ao_calc IMPLEMENTATION.
  ...
  METHOD if_sadl_exit_calc_element_read~calculate.
    ...
    data: lt_calc_data type standard table of zats_ao_travel_processor with DEFAULT KEY,
