...
define view entity ZATS_AO_BOOKSUPPL as select from /dmo/booksuppl_m
association to parent ZATS_AO_BOOKING as _Booking on
    $projection.BookingId = _Booking.BookingId and
    $projection.TravelId = _Booking.TravelId
association[1..1] to ZATS_AO_TRAVEL as _Travel on
